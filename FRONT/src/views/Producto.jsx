                        ...
                        <Card>
                            ...
                            <CardBody>
                                <div className="text-center">
                                    <CardTitle>
                                        Precio Original: <del>$<span
                                        className="text-danger">{this.props.producto.original_price}</span></del>
                                        <span className="text-muted"> ➡ </span>
                                        En GrupoB: <strong>$<span
                                        className="text-success">{this.props.producto.price}</span></strong>
                                    </CardTitle>
                                    <CardSubtitle>
                                        <span>Estado: <strong>{this.parsearEstado()}</strong></span>
                                        <span> – </span>
                                        <span>Vendedor en: <strong>{this.props.producto.state_name}</strong></span>
                                    </CardSubtitle>
                                </div>
                                <hr />
                                <Row>
                                    ...
                                    <Col xs="7">
                                        <Button className="btn btn-block btn-info" onClick={this.agregarACarrito}>Agregar
                                            al carrito</Button>
                                    </Col>
                                </Row>
                                <hr />
                                <Row>
                                    ...
                                    <Col>
                                        Calificación: {this.getEstrellas()}
                                    </Col>
                                </Row>
                                <hr />
